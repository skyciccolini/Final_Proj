...
# Updated ggplot
ggplot(PF_paths_combined_preds, aes(x = Restime, y = predicted_prob, linetype = Pathogen)) +
  geom_line() +
...
# Updated ggplot
ggplot(TP_paths_combined_preds, aes(x = FireTime, y = predicted_prob, linetype = Pathogen)) +
  geom_line() +
  geom_ribbon(aes(ymin = ci_lower, ymax = ci_upper), alpha = 0.2) +
...
PF_max_temp_summer_rescaled$predicted_prob_scaled <-
  PF_Fran_max_temp_summer_rescaled$predicted_prob * scale_factor

PF_max_temp_summer_rescaled$ci_lower_scaled <-
  PF_Fran_max_temp_summer_rescaled$ci_lower * scale_factor

PF_max_temp_summer_rescaled$ci_upper_scaled <-
...
ggplot() +
  ...
  geom_ribbon(data = TP_Fran_max_temp_summer_preds,
              aes(x = max_temp_summer, y = predicted_prob,
                  ymin = ci_lower, ymax = ci_upper, linetype = Site),
              alpha = 0.2) +
  geom_line(data = PF_max_temp_summer_rescaled,
