...
ggplot() +
  geom_point(data = PF_adult_gridMET_2018_2023_BOI, aes(x = Restime, y = FrancisellaPresence))
...
## cant really add raw data because such different y scales?
 ...
 geom_line(data = PF_Fran_Restime_preds, aes(x = Restime, y = predicted_prob),
            linetype = "dashed") +
  geom_ribbon(data = PF_Fran_Restime_preds, 
              aes(x = Restime, y = predicted_prob,
                  ymin = ci_lower, ymax = ci_upper), alpha = 0.2) +
  geom_line(data = PF_Rick_Restime_preds, aes(x = Restime, y = predicted_prob)) +
  geom_ribbon(data = PF_Rick_Restime_preds, 
              aes(x = Restime, y = predicted_prob,
                  ymin = ci_lower, ymax = ci_upper), alpha = 0.2) +
...
#plot
PF_Fran_Restime_plot <- ggplot(PF_Fran_Restime_preds, aes(x = Restime, y = predicted_prob)) +
  geom_line() +
  ylim(0.45, 0.8) +
  geom_ribbon(aes(ymin = ci_lower, ymax = ci_upper), alpha = 0.2) +
  labs(title = "(a)",
       x = "Reconstruction Year",
       y = "Francisella Predicted Probability") +
  theme_classic()


# Plot
PF_Fran_max_summer_temp_plot <- ggplot(PF_Fran_max_temp_summer_preds, aes(x = max_temp_summer, y = predicted_prob)) +
  geom_line() +
  ylim(0.45, 0.8) +
  geom_ribbon(aes(ymin = ci_lower, ymax = ci_upper), alpha = 0.2) +
  labs(title = "(b)",
       x = "Maximum Summer Temperature (°C)",
       y = "Francisella Predicted Probability") +
  theme_classic()

# Plot
PF_Fran_Mean_PDSI_plot <- ggplot(PF_Fran_Mean_PDSI_preds, aes(x = Mean_PDSI, y = predicted_prob)) +
  geom_line() +
  ylim(0.45, 0.8) +
  geom_ribbon(aes(ymin = ci_lower, ymax = ci_upper), alpha = 0.2) +
  labs(title = "(c)",
...
#plot
TP_Fran_FireTime_plot <- ggplot(TP_Fran_FireTime_preds, aes(x = FireTime, y = predicted_prob)) +
  geom_line() +
  ylim(0.50, 0.80) +
  geom_ribbon(aes(ymin = ci_lower, ymax = ci_upper), alpha = 0.2) +
    labs(title = "(a)",
...
# Plot
TP_Fran_max_summer_temp_plot <- ggplot(TP_Fran_max_temp_summer_preds, aes(x = max_temp_summer, y = predicted_prob)) +
  geom_line() +
  #ylim(0.50, 0.80) +
  geom_ribbon(aes(ymin = ci_lower, ymax = ci_upper), alpha = 0.2) +
  labs(title = "(b)",
...
# Plot
TP_Fran_Mean_PDSI_plot <- ggplot(TP_Fran_Mean_PDSI_preds, aes(x = Mean_PDSI, y = predicted_prob)) +
  geom_line() +
  ylim(0.50, 0.80) +
  geom_ribbon(aes(ymin = ci_lower, ymax = ci_upper), alpha = 0.2) +
  labs(title = "(c)",
