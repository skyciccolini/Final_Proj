...
PF_Fran_Restime_AA <- PF_adult_gridMET_2018_2023_BOI |> 
  filter(SPECIES == "AA")

# predicted values
PF_Fran_Restime_AA_preds <- data.frame(
  Restime = seq(min(PF_Fran_Restime_AA$Restime), max(PF_Fran_Restime_AA$Restime), length.out = 100),
  max_temp_summer = mean(PF_Fran_Restime_AA$max_temp_summer),
  Mean_PDSI = mean(PF_Fran_Restime_AA$Mean_PDSI),
  SPECIES = rep("AA", 100)
)

PF_Fran_Restime_AA_preds$predicted_prob <- predict(PF_Fran_Res_climate_int_spp_glm, 
                                                newdata = PF_Fran_Restime_AA_preds, type = "response") ### you need to split predictions for everything into AA and DV
...
PF_Fran_max_temp_summer_preds$predicted_prob <- predict(PF_Fran_Res_climate_int_spp_glm, 
...
# Add predicted probabilities
PF_Fran_Mean_PDSI_preds$predicted_prob <- predict(PF_Fran_Res_climate_int_spp_glm, 
...
TP_Fran_FireTime_preds$predicted_prob <- predict(TP_Fran_Res_climate_int_spp_glm, 
...
# Add predicted probabilities
TP_Fran_max_temp_summer_preds$predicted_prob <- predict(TP_Fran_Res_climate_int_spp_glm, 
...
# Add predicted probabilities
TP_Fran_Mean_PDSI_preds$predicted_prob <- predict(TP_Fran_Res_climate_int_spp_glm, 
...
PF_Rick_Restime_preds$predicted_prob <- predict(PF_Rick_Res_climate_int_spp_glm, 
...
# Add predicted probabilities
PF_Rick_max_temp_summer_preds$predicted_prob <- predict(PF_Rick_Res_climate_int_spp_glm, 
...
# Add predicted probabilities
PF_Rick_Mean_PDSI_preds$predicted_prob <- predict(PF_Rick_Res_climate_int_spp_glm, 
...
TP_Rick_FireTime_preds$predicted_prob <- predict(TP_Rick_Res_climate_int_spp_glm, 
...
# Add predicted probabilities
TP_Rick_max_temp_summer_preds$predicted_prob <- predict(TP_Rick_Res_climate_int_spp_glm, 
...
# Add predicted probabilities
TP_Rick_Mean_PDSI_preds$predicted_prob <- predict(TP_Rick_Res_climate_int_spp_glm, 
