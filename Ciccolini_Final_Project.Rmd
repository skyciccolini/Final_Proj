...
st_crs(sites_sf) <-"+proj=laea +lon_0=-93.0468754 +lat_0=39.6127177 +datum=WGS84 +units=m +no_defs"
...
inset_map <- ggplot(usa_states) +
  geom_sf(fill = "gray90", color = "white") +
  geom_sf(data = sites_sf, color = "blue", size = 3) +
  coord_sf(xlim = c(-92.5, -92.2), ylim = c(38.9, 39.1), expand = FALSE) +
  theme_void()

# Combine maps
main_map +
  inset_element(inset_map, 0.6, 0.6, 1, 1)
